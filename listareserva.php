...
<body>
	...
	<button onclick="window.location.href='reservas.html?data='+url()" type="button" class="button3" style="width: 7%" background-color: #f44336;}>Atrás</button>
	</div>
</body>
</html>
